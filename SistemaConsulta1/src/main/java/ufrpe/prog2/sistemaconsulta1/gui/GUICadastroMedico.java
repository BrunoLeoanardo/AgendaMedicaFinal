...
public class GUICadastroMedico extends javax.swing.JFrame {
    ...
    private void jButtonCadastrarMedicoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarMedicoActionPerformed
        // TODO add your handling code here:
        try {
            String nome = jTextFieldNomeMedico.getText().trim();
        String esp = jTextFieldEspecialidade.getText().trim();

        if (nome.isEmpty() || esp.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Preencha nome e especialidade.");
            return;
        }

        // chama Fachada que espera strings
        ufrpe.prog2.sistemaconsulta1.negocio.Fachada.getInstance()
            .cadastrarMedico(nome, esp);
