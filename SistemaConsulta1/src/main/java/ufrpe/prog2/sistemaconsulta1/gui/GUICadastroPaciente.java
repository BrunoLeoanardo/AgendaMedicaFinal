...
public class GUICadastroPaciente extends javax.swing.JFrame {
    ...
    private void jButtonCadastrarPacienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarPacienteActionPerformed
        ...
        // chama a fachada que espera strings
        ufrpe.prog2.sistemaconsulta1.negocio.Fachada.getInstance()
            .cadastrarPaciente(nome, cpf, telefone, email);
    ...
    } catch (ufrpe.prog2.sistemaconsulta1.negocio.DadosInvalidosException ex) {
        // mostra mensagem de validação específica
        javax.swing.JOptionPane.showMessageDialog(this, "Erro de validação: " + ex.getMessage(), "Erro", javax.swing.JOptionPane.ERROR_MESSAGE);
    } catch (Exception e) {
        javax.swing.JOptionPane.showMessageDialog(this, "Erro: " + e.getMessage(), "Erro", javax.swing.JOptionPane.ERROR_MESSAGE);
    }
